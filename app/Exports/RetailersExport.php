...
class RetailersExport implements FromQuery, WithHeadings, WithMapping, WithStyles, ShouldAutoSize
{
 ...
 {
 return [
 'ID', 'Name', 'Email', 'Phone', 'Shop Name', 'Address', 'City', 'State',
 'Pincode', 'GST Number', 'PAN Number', 'Commission Tier', 'KYC Status',
 'Wallet Balance', 'Total Transactions', 'Total Spent', 'Joined Date',
 ];
 }
 ...
 $retailer->gst_number ?? '-',
 $retailer->pan_number ?? '-',
 ucfirst($retailer->commission_tier),
